 ...
 * @author Grandalf
 */
public class ControladorCasos extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        String codigoDel = request.getParameter("codigoDel");
        ...
        request.setAttribute("verificacionCasoAlta", m.altaCaso(codigoSucDel, juezEncargado, codigoDel, fechaDelito, tiempoCondena, condena, implicadosArray));
    ...
    public void doGet(HttpServletRequest request,
        ...
        switch (request.getParameter("accion")) {
            case "Modificar":
                Integer codigoDelMod = Integer.valueOf(request.getParameter("codigoDelBaja"));
                
                request.setAttribute("verificacionCasoBusqueda", m.buscarCaso(codigoDelMod));
                request.setAttribute("caso", m.getCaso());
                m.cargarDatos(request, response);
                vista = request.getRequestDispatcher("vistaModificacion.jsp");
                vista.forward(request, response);
                break;
            case "Baja":
                Integer codigoDelBaja = Integer.valueOf(request.getParameter("codigoDelBaja"));
                
                request.setAttribute("verificacionCasoBaja", m.bajaCaso(codigoDelBaja));
                m.cargarDatos(request, response);
                vista = request.getRequestDispatcher("vistaResultadoAdministrador.jsp");
                vista.forward(request, response);
        }
